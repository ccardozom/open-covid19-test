      ...
      <form @submit.prevent="getEvaluation">
        <radio-question
          question="¿Tienes sensación de falta de aire de inicio brusco (en ausencia de cualquier otra patología que justifique este síntoma)?
                    <li>¿Reñandú angaipa yvytu mba'e ha'ete reñepytyhorõ?</li>"
          name="airShortness"
        ></radio-question>
        <radio-question
          question="¿Tienes fiebre? (+37.7ºC)
                    <li>¿Rereko akãnundu? (+37.7ºC)</li>"
          name="fever"
        ></radio-question>
        <radio-question
          question="¿Tienes tos seca y persistente?
                    <li>¿Nde hu'u manterei?</li>"
          name="dryCough"
        ></radio-question>
        <radio-question
          question="¿Has tenido contacto estrecho con algún paciente positivo confirmado?
                    <li>¿Reñe'e o reiko avandi orekova COVID-19?</li>"
          name="closeContact"
        ></radio-question>
        <radio-question
        ...
        <radio-question
          question="¿Llevas más de 20 días con estos síntomas?
                   <li>¿20 mba'e ara kuerama peicha reĩme?</li>"
          name="twentyDays"
        ></radio-question>
        <div class="right">
          <router-link class="back" to="/">Volver (Ñepyrũ)</router-link>
          <button type="submit">
            Obtener resultados (Osẽva tembiapógui)
          </button>
        </div>
      </form>
    </div>
